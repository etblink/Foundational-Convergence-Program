...
- **Latest canonical maintenance operation:** `POST_FW_PROCESS_MATRIX_REALIZABILITY_PHYSICAL_SELECTION_STAGE1_PREREGISTRATION_ROUTING_AND_NAVIGATION_RECONCILIATION`; the targeted realizability / physical-selection Stage-1 preregistration is frozen, while the first external search remains separately unauthorized and unstarted.
...
- **Next recommended program operation:** `FW_PROCESS_MATRIX_TARGETED_REALIZABILITY_AND_PHYSICAL_SELECTION_SOURCE_STRENGTHENING_STAGE1` execution under the frozen preregistration, but only after separate authorization to cross the first external-literature-search boundary. No external query has started.
...
TARGETED_REALIZABILITY_SOURCE_STRENGTHENING_STAGE1_STATUS = PREREGISTERED_STAGE1_ONLY__EXTERNAL_SEARCH_NOT_STARTED
TARGETED_REALIZABILITY_STAGE1_PREREGISTRATION_COMMIT = ceb582bac0554a310f8968fa19b13c39f0837b63
TARGETED_REALIZABILITY_PREREGISTRATION_FROZEN = YES
TARGETED_REALIZABILITY_PUBLICATION_CUTOFF = 2026-08-29_INCLUSIVE
TARGETED_REALIZABILITY_NEW_EXTERNAL_SOURCE_SEARCH_STARTED = NO
...
Method 0.2.1 inherits these unaffected Method 0.2.0 axes and continues to report them separately. It does not use a scalar framework-winner score.
...
- [`governance/`](governance/) — Method 0.2.0 and governance artifacts, including the frozen FCP-23/FCP-24 preregistrations and the publication-provenance/ref-lifecycle policy.
- [`governance/FCP_PUBLICATION_PROVENANCE_AND_REF_LIFECYCLE_POLICY_0_1_0.md`](governance/FCP_PUBLICATION_PROVENANCE_AND_REF_LIFECYCLE_POLICY_0_1_0.md) — qualification/publication identity, content-equivalent publication, bundle fallback, and remote-ref lifecycle rules.
