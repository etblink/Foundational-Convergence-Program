...
| `FW-NFC-RED` | Reduced NFC | reduced comparative object only | `PAIRWISE_COMPARISON_COMPLETE` | Prospective NFC/strengthened-AS reanalysis remains the latest canonically integrated NFC comparison. This branch additionally records a qualified, not-integrated prospective NFC/strengthened-LOOP candidate: 29 atomic records yield E1 = 0, E2 = 0, E3 = 0, E4 = 0, E5 = 7, NONE = 22, and UNRESOLVED = 0. The seven independently instantiated (`IND-I`) roles are mathematically generic S0 carrier, admissibility, viability, observable/interface, localization, coarse/fine, and global-coherence functions; no non-generic relation, pairwise empirical selection, convergence credit, or evidence for NFC is established. Strengthened LOOP E3-S/E3-M content sharpens dynamics/continuum/realization asymmetry, so FCP-17's current interpretation is a branch-local `PARTIALLY_SUPERSEDED` candidate without changing its immutable artifact or historical K-key topology |
...
| `FW-LOOP` | Loop / spin-network / spinfoam approaches | source-bound quantum-gravity comparator family | `PAIRWISE_COMPARISON_COMPLETE` | Targeted source strengthening remains canonically complete: fixed-building-block E3-S and refined/regularized, linearized, and cosmological E3-M recovery are source-qualified, while E3-F, E3-P, framework-level calibrated observables and EMP4 remain unestablished. This branch additionally records a qualified, not-integrated Reduced-NFC/strengthened-LOOP reanalysis: the LOOP-internal E3 records remain positive target-conditioned viability evidence but create no pairwise E3, the canonical/covariant internal bridge creates no pairwise E2, seven generic S0 E5 roles survive, and stronger LOOP realization content yields `NONEMPTY__STRENGTHENED` material asymmetry. LQC remains excluded and historical FCP-17 remains immutable |
...
## Prospective Reduced-NFC/strengthened-LOOP reanalysis — branch-local candidate

This research branch applies Method 0.2.0 prospectively to the exact FCP-3 Reduced-NFC object, the exact FCP-15/FCP-16/FCP-17 historical LOOP chain, and the canonically admitted targeted-source-strengthening LOOP packet. The candidate is qualified but not integrated.
...
Historical key-level topology remains K1/K3/K5/K6/K7/K8 E5-only and K2/K4/K9/K10 NONE. The branch-local partial supersession concerns claim-level precision and stronger LOOP dynamics/continuum/realization asymmetry.

No recurrence, claim-ledger propagation, source-register mutation, LOOP taxonomy change, branch cleanup, scalar score, framework winner, or FCP-25 follows from this branch-local candidate.
