...
| `FW-PROCESS-MATRIX` | Process-matrix operational framework | source-bound generalizing causal-process meta-framework | `SOURCE_BOUND_READY` | Dedicated causal-process Stage-2 taxonomy under Method 0.2.1 admits the generalized process-matrix object after A–H all pass. Its canonical K1–K10 baseline is now complete: K1/K3/K5/K6/K8 are strongly native; K2/K9 are scope-qualified; K4 has no base framework history selector; K7 has no framework-wide scale relation; and K10 has no framework-level empirical discriminator at the frozen source scope. The framework remains distinct from ICO, causal nonseparability, causal-inequality violation, quantum switch/QC-QC, resource theory, experimental implementation, indefinite spacetime, and QG. No pairwise comparison, convergence credit, recurrence result, framework-level empirical selection, or independent post-admission audit has yet been performed |
