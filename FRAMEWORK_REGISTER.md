...
|---|---|---|---|---|
| `FW-NULL-GRQFTSM` | GR + QFT + Standard Model, no deeper ontology assumed | first-class null competitor | `PAIRWISE_COMPARISON_COMPLETE` | FW-STRING-M remediated null control is the latest null comparison candidate: 20 claim-level records yield String/M↔null E1 = 0, E2 = 0, E3 = 1 (`E3-S` low-energy Einstein metric substructure spanning K4/K7), E4 = 0, E5 = 6, NONE = 13, UNRESOLVED = 0; six core String/M-specific additional-commitment incidences survive generic/GR-QFT-lineage/target/model/empirical subtraction as a nonempty bounded `S3_FRAMEWORK_WIDE` family residue, while no direct `FW-STRING-M` framework empirical discriminator or framework-level empirical selection is identified |
| `FW-NFC-RED` | Reduced NFC | reduced comparative object only | `PAIRWISE_COMPARISON_COMPLETE` | FCP-22 is the latest bounded NFC pairwise result: strengthened AQFT now supports a mathematically generic `E5_FUNCTIONAL_RELATION` to Reduced-NFC Interface Sufficiency at formal substructure scope, while pairwise E1–E4 remain `NONE_ESTABLISHED`, no non-generic independent foundational relation or pairwise empirical selection is established, and historical FCP-6 remains immutable as a source-bounded result; FCP-21 remains the latest NFC/AS control |
...
| `FW-STRING-M` | String/M-theory framework family | source-bound quantum-gravity comparator family | `PAIRWISE_COMPARISON_COMPLETE` | Remediated Method-0.2.0 null control candidate is qualified: 20 claim-level records yield E1 = 0, E2 = 0, one bounded `E3-S` low-energy Einstein metric recovery relation spanning K4/K7, E4 = 0, E5 = 6, NONE = 13, UNRESOLVED = 0; six core String/M-specific additional commitments survive across carrier, duality, formulation/transformation, dynamics, scale and consistency structure, with a bounded `S3_FRAMEWORK_WIDE` family residue and no direct framework-level empirical discriminator or empirical selection |
