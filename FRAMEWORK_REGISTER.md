...
| `FW-NFC-RED` | Reduced NFC | reduced comparative object only | `PAIRWISE_COMPARISON_COMPLETE` | Branch-local, not-integrated NFC/String-M candidate: eight claim-level candidates yield E1 = 0, E2 = 0, E3 = 0, E4 = 0, E5 = 3, NONE = 5, and UNRESOLVED = 0. The three E5 roles—declared-invariant description coordination, admissible-transformation typing, and conditional global coherence—are independently instantiated but mathematically generic at S0; no non-generic relation, pairwise empirical selection, convergence credit, or evidence for NFC is established, and material asymmetries are nonempty. FCP-22 remains the latest canonical NFC pairwise result unless this candidate is integrated |
...
| `FW-STRING-M` | String/M-theory framework family | source-bound quantum-gravity comparator family | `PAIRWISE_COMPARISON_COMPLETE` | Branch-local, not-integrated NFC/String-M candidate: the exact six-incidence residue produces three mathematically generic S0 E5 functional relations and five NONE records across eight claim-level candidates, with zero E1–E4, zero non-generic relations, no pairwise empirical selection, and no NFC empirical support. String/M's carrier, quantum, dynamical, dimensional/duality, realization, low-energy-recovery, and limited empirical content remain material asymmetries. The remediated null control and its nonempty bounded S3 residue remain canonically complete |
