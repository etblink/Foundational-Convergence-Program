...
| `FW-NFC-RED` | Reduced NFC | reduced comparative object only | `PAIRWISE_COMPARISON_COMPLETE` | Prospective NFC/strengthened-AS reanalysis is canonically complete: 17 atomic records yield E1 = 0, E2 = 0, E3 = 0, E4 = 0, E5 = 3, NONE = 14, and UNRESOLVED = 0. The three E5 roles—admissible-family delimitation, selected outcome/observable mediation, and indexed global coherence—are independently instantiated (`IND-I`) but mathematically generic at S0; no non-generic relation, pairwise empirical selection, convergence credit, or evidence for NFC is established. Stronger AS global, Lorentzian, and model-observable content sharpens realization asymmetry, so FCP-21's current interpretation is `PARTIALLY_SUPERSEDED` without changing its historical artifacts or K-key relation topology. The earlier canonical NFC/String-M comparison remains unchanged |
