...
| `SRC-FCP-TSS-AQFT-BF-2024` | `FW-AQFT` / current specialist synthesis | D. Buchholz, K. Fredenhagen, *Algebraic quantum field theory: objectives, methods, and results* | arXiv `2305.12923v2` dated 2024-07-22 | `SOURCE_BOUND_REVIEW_PREPRINT` | Commissioned encyclopedia-review preprint. Current status source, not primary theorem authority; final publication DOI was not resolved in the inspected record. |
...
| `SRC-FCP-TSS-AS-PRW-2025` | `FW-AS` / self-consistent Lorentzian spectral function | J. M. Pawlowski, M. Reichert, J. Wessely, *Self-consistent graviton spectral function in Lorentzian quantum gravity* | arXiv `2507.22169v1` dated 2025-07-29 | `SOURCE_BOUND_PREPRINT` | Primary preprint. Selected spectral truncation and renormalization conditions; positivity is not framework-wide unitarity. |
