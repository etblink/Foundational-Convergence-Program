...
# The top summary and aggregate-accounting sections intentionally carry the
# same incidence block. Replace both, while keeping all other repairs exact.
old_counts = (
...
if s.count(old_counts) != 2:
    raise SystemExit(f'COUNT_BLOCK_MULTIPLICITY_FAIL count={s.count(old_counts)}')
